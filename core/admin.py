...
from .models import ShareType, Member, SavingsAccount, Transaction, Loan, LoanPayment
...
class ShareTypeAdmin(AdminMixin, admin.ModelAdmin):
...
admin.site.index_title = "🏦 Welcome to Crested SS 2005 Class"